export const testimonials = [
  ...
  },
  {
    ...
    rating: 5,
    text: 'Would rate it a good 5 because not only the code worked well, but they were responsible and hardworking in finishing the task too. They can follow requests well and make the coding accurate to what we are trying to show or explain. They are also open to suggestions and can fix problems quickly. Can finish tasks fast, especially when we asked for help with limited time. They are one of the reasons why we made it to the regionals, were able to present our device, and achieved 4th place in the innovation field.',
  },
  {
    id: 3,
    name: 'Isabelle',
